...
using Employee.Client.HttpHandlers;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
            {
                ...
                options.ClientId = "employee_mvc_client";
                options.ClientSecret = "secret";
                options.ResponseType = "code id_token"; //using hybrid flow configuration 

                //options.Scope.Add("openid");
                //options.Scope.Add("profile");
                options.Scope.Add("address");
                options.Scope.Add("email");
                options.Scope.Add("employerAPI");
            ...
            // 1. Create an HttpClient used for accessing employee.API
